...
//        zoo.addAnimal(new Animal("Bear"));
        ...
        Zoo zoo = new Zoo();
        zoo.addObserver(new PrintNameAnimalAddedListener("Jack"));
        zoo.addAnimal(new Animal("Tiger"));
        zoo.notifyObservers();
        PrintNameAnimalAddedListener al1 = new PrintNameAnimalAddedListener("Sarah");
        PrintNameAnimalAddedListener al2 = new PrintNameAnimalAddedListener("Jane");
        zoo.addObserver(al1);
        zoo.addObserver(al2);
        zoo.addAnimal(new Animal("Lion"));
        zoo.notifyObservers();
        zoo.removeObserver(al1);
        zoo.addAnimal(new Animal("Bear"));
        zoo.notifyObservers();
